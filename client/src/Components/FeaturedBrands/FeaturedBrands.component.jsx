        ...
        <div className='products-container'>
            {
              ...
              .map(shoe =>(<Card id={shoe._id}  key={shoe._id} name={shoe.brand +' '+ shoe.name} discount={shoe.price} price={ + shoe.price - shoe.discount} imageUrl={shoe.images[0]} button={"Add to cart"}/>))
            }
        </div>
        </>
    );
